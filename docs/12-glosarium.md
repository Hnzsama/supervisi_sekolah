...
## Glosarium Istilah Domain Supervisi Guru

Berikut adalah definisi istilah dan akronim yang digunakan dalam sistem supervisi:

| Istilah | Definisi / Keterangan |
| :--- | :--- |
| **Supervisi Akademik** | Serangkaian kegiatan membantu guru mengembangkan kemampuannya mengelola proses pembelajaran demi mencapai tujuan pembelajaran. |
| **Pengawas Sekolah** | Pejabat definitif yang bertugas melakukan pengawasan, pembinaan, dan supervisi terhadap sejumlah sekolah dampingan. |
| **Kepala Sekolah** | Pemimpin satuan pendidikan yang bertanggung jawab melakukan supervisi terhadap seluruh guru di sekolahnya. |
| **Guru** | Tenaga pendidik yang menjadi subjek supervisi akademik. |
...
| **Tindak Lanjut** | Program atau aksi pembinaan pasca-observasi untuk memperbaiki atau meningkatkan kualitas mengajar guru. |
| **Periode Supervisi** | Rentang waktu pelaksanaan supervisi (biasanya per semester atau per tahun ajaran). |
